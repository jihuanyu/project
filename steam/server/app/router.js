 ...
 * @Last Modified time: 2019-12-17 16:33:51
 * @Func: 应用的路由配置部分
 */
module.exports = app => {
    ...
    router.get(
        ...
        controller.exam.questionsType.insertQuestionsType
    );
    ...
    router.get(
        ...
        controller.exam.questionsType.getQuestionsType
    );
    /**
     * 删除单个试题类型
     * 入参：{id:待删除的试题类型的id}
    ...
    router.post(
        ...
        controller.exam.questionsType.delQuestionsType
    );
    /**
     * resources对应路径说明
     * /posts GET => index
     ...
     * 面试题的CURD接口
     */
    router.get("/exam/interview", controller.exam.interview.new);
    router.get("/exam/interview/show", controller.exam.interview.show);
    router.post("/exam/interview/add", controller.exam.interview.create);

    // router.resources('/exam/interview', controller.exam.interview);
    // router.resources('/Interview/exam',controller.Interview.exam);
    ...
    router.post(
        ...
        controller.user.user.cancelIdentityApi
    );
    // 给身份设置视图
    ...
    router.post(
        ...
        controller.user.user.cancelIdentityView
    );
    /**
     * 老师登录接口
     */
     ...
     * 获取首页统计相关数据
     */
    router.get("/home/search/report", controller.home.report.report);
    router.get(
        "/home/questions/report",
        controller.home.report.questionsReport
    );
    router.get("/", controller.home.render.render);
};
